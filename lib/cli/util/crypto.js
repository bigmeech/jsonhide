 ...
 * .jsoncrypt is public while .jsoncrpt.private
 */
exports.createKeyPairs = function createKeyPairsFn () {
    ...
    const publicKeyFilePath = path.resolve(__dirname, process.cwd(), '.jsoncrypt');
    const privateKeyFilePath = path.resolve(__dirname, process.cwd(), '.jsoncrypt.private');
